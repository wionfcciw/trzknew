<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleUserTypeSet.aspx.cs" Inherits="SincciKC.system.RoleUserTypeSet" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>角色用户类型设置</title>
...
<body>
    ...
    <div> 
   <div style="font-size: medium; font-weight: bold; text-align:center; height:28px" >角色［<asp:Label ID="lblRoleName" runat="server" Text=""></asp:Label>］设置用户类型</div> 
