<%@ Page Language="C#" ViewStateMode="Disabled" AutoEventWireup="true" CodeBehind="jsxm_Help.aspx.cs" Inherits="SincciKC.webUI.tyxm.jsxm_Help" %>
            ...
            <div  style="border:1px solid #DFF3FE; background-color:#DFF3FE; margin-left:10px ; padding:1px; width:855px" >
                <div  style="background-color:#FFFFFF;">
                    ...
                    <table width="850" border="0" style="border-collapse: collapse;" align="center" cellpadding="0"
                        ...
                        <tr>
                            <td align="center">
                                <asp:Button ID="btnNext" CssClass="register2" runat="server" Text="加试信息采集" OnClick="btnNext_Click" />
