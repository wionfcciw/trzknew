<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jsxm_Input.aspx.cs" Inherits="SincciKC.webUI.tyxm.jsxm_Input" %>
        ...
        <div class="center_content" style=" margin-left:5px" > 
            ...
            <%--    <div  class="tbltitle" >铜仁市<asp:Label runat="server" ID="SysYear"></asp:Label>中等学校体育考试考生报名信息采集表</div>--%>
                 ...
                 <table  width="850" border="0" style="border-collapse: collapse;" align="center" cellpadding="0" cellspacing="0">
                     ...
                     <tr>
                         <td>
                             <table width="100%" border="1" bordercolor="#B0DFFD" style="border-collapse: collapse;   font-size:12px"
                                 ...
                                 <tr><td colspan="4"><%--加试考试信息--%>报考信息</td></tr>
                                  <tr>
                                              <td align="right">
                                       <font color="red">*</font>报考学校：</td>
                                       <td colspan="3">
                                           <%--铜仁师范--%> 江苏省铜仁中等专业学校 </td>
                                 </tr>
                                  ...
                                  <tr>
                                              <td align="right">
                                       <font color="red">*</font><%--加试专业报考--%>报考专业：</td>
                     ...
                     <tr>
                         <td align="center">
                             <asp:Button ID="btnSave" runat="server" CssClass="register" Text=" 保 存 "     onclick="btnSave_Click" />
                             &nbsp;&nbsp;
