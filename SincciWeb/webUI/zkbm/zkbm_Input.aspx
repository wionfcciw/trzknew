<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zkbm_Input.aspx.cs" Inherits="SincciKC.webUI.zkbm.zkbm_Input" %>
        ...
        if (document.getElementById("ddlzjlb").value == 1) {
            if (document.getElementById("txtsfzh").value.length > 0) {
                ...
                if (18 == cardLen) {
                   ...
                   // alert(document.getElementById("ddlxb").value);
             ...
             <div  style="border:5px solid #DFF3FE; margin-left:10px ; padding:2px; width:855px" >
                <div  class="tbltitle" >铜仁市<asp:Label runat="server" ID="SysYear"></asp:Label>中等学校招生考试考生报名信息采集表</div>
                 ...
                 <table  width="850" border="0" style="border-collapse: collapse;" align="center" cellpadding="0" cellspacing="0">
                         ...
                         <td>
                             ...
                             <ContentTemplate>
                                 ...
                                 <tr>
                                     ...
                                     <td colspan="3"><asp:DropDownList ID="ddljtdq" runat="server"   AutoPostBack="true"
                     ...
                     <tr>
                         <td align="center">
                             <asp:Button ID="btnSave" runat="server" CssClass="register" Text=" 保 存 "   OnClientClick="return YY_checkform()"
