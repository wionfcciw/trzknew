<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="zzsb.aspx.cs" Inherits="SincciKC.webUI.zzsb.zzsb" %>
...
//           }
       ...
       function showPop(Title, url, width, height, returnFunc, showCloseBox, showScrolling,str) {//点击学校代码
           ...
           if (num > 1) {
               ...
               if (pcDm == "12" && xpcid.substring(0, 4) == "0684") { //海门
