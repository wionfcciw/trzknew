...
{
    public partial class bmgl_bktj_Print_qr : BPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = "websystem/rdlc/Print_qr.rdlc";
        ...
        private DataTable xqPrint()
        {
            ...
            if (str.IndexOf("*") == -1)
            {
                if (str == "")
                {
                    dtLast = bll.Select_xqtj_qr(kaoci);
                }
                else
                {
            ...
            dtLast.Columns.Add("zjxxqrrs");
            dtLast.Columns.Add("yjxxqrrs");
            dtLast.Columns.Add("wjxxqrrs");
        ...
        private DataTable xxPrint()
        {
            ...
            if (str.IndexOf("*") == -1)
            {
                if (str == "")
                {
                    dtLast = bll.Select_xxtj_qr(xqdm, kaoci);
            ...
            dtLast.Columns.Add("zjxqqrrs");
            dtLast.Columns.Add("yjxqqrrs");
            dtLast.Columns.Add("wjxqqrrs");
