<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bmgl_bktj_xq_where.aspx.cs" Inherits="SincciKC.websystem.bmgl.bmgl_bktj_xq_where" %>
...
.btn
{
    ...
    <script type="text/javascript">
        function opdg(where, ID, Title, tiaojian, kaoci) {

            window.parent.addTab2(Title, '/websystem/bmgl/bmgl_bktj_xx_where.aspx?kaoci=' + kaoci + '&tiaojian=' + tiaojian + '&xqdm=' + ID + '&where=' + where + '&title=' + Title);
            return false;
        }
        function hideTest(Title, kaoci,where) {
            window.parent.addTab2(Title, '/websystem/bmgl/bmgl_bktj_Print_where.aspx?kaoci=' + kaoci + '&where=' + where + '&type=1&title=' + Title);
            return false;
        }
    </script>
</head>
    ...
    <form id="form1" runat="server"  >
     ...
     <div id="tb" class="datagrid-toolbar"  >
         ...
         <table border="0" cellpadding="0" cellspacing="0">
             <tr>
             <td>   考次:  <asp:DropDownList ID="drpKaoci" runat="server">
          </asp:DropDownList> 
       </td>
                 <td>性别: 
        ...
        <HeaderTemplate>
         ...
         <ItemTemplate> 
                  ...
                  <%--  <td><%#Eval("xbdm").ToString()=="1"? "男":"女"%> </td>
                      ...
                      <td>  <a href="#" onclick='return opdg("<%=str%>","<%#Eval("xqdm")%>","学校报名分析","<%=tiaojian%>","<%=kaoci %>");'><%#Eval("xqmc").ToString()=="合计"?"":"详情" %></a>
                      </td>                 
