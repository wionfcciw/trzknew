<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bmgl_bktj_xx.aspx.cs" Inherits="SincciKC.websystem.bmgl.bmgl_bktj_xx" %>
...
.btn
{
    ...
    <script type="text/javascript">
        function opdg(bmddm, xqdm, Title,kaoci) {

            window.parent.addTab2(Title, '/websystem/bmgl/bmgl_bktj_bj.aspx?kaoci=' + kaoci + '&bmddm=' + bmddm + '&xqdm=' + xqdm + '&title=' + Title);
            return false;
        }
        function hideTest(xqdm, Title,kaoci) {

            window.parent.addTab2(Title, '/websystem/bmgl/bmgl_bktj_Print.aspx?kaoci=' + kaoci + '&type=2&xqdm=' + xqdm + '&title=' + Title);
            return false;
        }
    </script>
</head>
        ...
        <HeaderTemplate>
         ...
         <ItemTemplate> 
                  ...
                  <%--  <td><%#Eval("xbdm").ToString()=="1"? "男":"女"%> </td>
                      ...
                      <td><%#Eval("wjqrrs")%> </td> 
                      <td><%#Eval("wjwqrrs")%></td> 
                      <td><a href="#" onclick="return opdg('<%#Eval("bmddm")%>','<%=xqdm%>','班级报名统计','<%=kaoci %>');"><%#Eval("bmdmc").ToString() == "合计" ? "" : "详情"%></a>
                      </td>                 
