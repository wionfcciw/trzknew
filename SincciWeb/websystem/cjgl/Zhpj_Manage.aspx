<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zhpj_Manage.aspx.cs" Inherits="SincciKC.websystem.cjgl.Zhpj_Manage" %>
 ...
 <link rel="stylesheet" type="text/css" href="../../easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        ...
        function opdg(ID, Title) {
            ymPrompt.win({ message: 'Zhpj_AddEdit.aspx?ksh=' + ID, width: 350, height: 405, title: Title, iframe: true, fixPosition: true, dragOut: false })
            return false;
        }
        function SelectAll() {
...
<body>
   ...
   <div id="tb" class="datagrid-toolbar"  >
         <table>
             ...
             <tr>
             <td><asp:Button ID="btnEdit" runat="server" CssClass="icon-edit" Text="  修改" 
                    onclick="btnEdit_Click" /><asp:Button ID="btnDelete" runat="server" Text="  删除" CssClass="icon-remove btn"
            OnClientClick="return MsgYes();" OnClick="btnDelete_Click" /></td>
                 ...
                 <td>
                  <asp:TextBox ID="txtName" runat="server" Width="100px" CssClass="searchbox"></asp:TextBox>
    ...
    <div id="tbpage" class="datagrid-toolbar" style="padding-left: 10px">
     ...
     <div class="datagrid-toolbar"  runat="server" id="divdaor">&nbsp;&nbsp;数据导入：<asp:FileUpload ID="fuExcelFileImport" runat="server" CssClass="searchbox" />
        ...
        <a href="../../Template/zhszpjTemplate.xls" >模板下载</a>
    </div>
