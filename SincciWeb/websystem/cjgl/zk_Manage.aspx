<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zk_Manage.aspx.cs" Inherits="SincciKC.websystem.cjgl.zk_Manage" %>
...
<body>
   ...
   <div id="tb" class="datagrid-toolbar"  >
         <table>
             <tr> <td>
                 <asp:Button ID="btnEdit" runat="server" CssClass="icon-edit" Text="  修改" 
                    onclick="btnEdit_Click" Visible="False"   /></td>
    ...
    <div id="tbpage" class="datagrid-toolbar" style="padding-left: 10px">
     ...
     <div class="datagrid-toolbar"  runat="server" id="divdaor" visible="false">&nbsp;&nbsp;数据导入：<asp:FileUpload ID="fuExcelFileImport" runat="server" CssClass="searchbox"  />
        ...
        <a href="../../Template/zkcjTemplate.xls">模板下载</a>
    </div>
