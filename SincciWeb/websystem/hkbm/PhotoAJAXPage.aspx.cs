...
namespace SincciKC.websystem.hkbm
{
    public partial class PhotoAJAXPage : BPage
    {
        ...
        private void UpLoadImage()
        {
            ...
            if (file != null)
            {
                try
                {
                    ...
                    string FolderPath = Server.MapPath("//14hk//" + xqdm + "//");
                    mainPath = Server.MapPath("//14hk//" + xqdm + "//" + ksh + ".jpg");
        ...
        private void GetSwSh()
        {
            ...
            result += "," + "http://" + HttpContext.Current.Request.Url.Host + systemparam.hkPicPath;
        ...
        private void GetUserImagePath()
        {
            ...
            if (pic == "1")
                path = Server.MapPath("//14hk//" + xqdm + "//" + ksh + ".jpg");
        ...
        private void GetData()
        {
            ...
            DataTable result = bllHkbm.ExecuteProcList(whereStr, rows, pageSize, ref RecordCount);
