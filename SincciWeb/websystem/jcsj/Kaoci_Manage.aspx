<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kaoci_Manage.aspx.cs" Inherits="SincciKC.websystem.jcsj.Kaoci_Manage" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function opdg(ID, Title) {
            ymPrompt.win({ message: 'Kaoci_AddEdit.aspx?kcdm=' + ID, width: 360, height: 260, title: Title, iframe: true, fixPosition: true, dragOut: false })
            return false;
        }
        function SelectAll() {
...
<body>
    ...
    <div id="tb" class="datagrid-toolbar">
        ...
        &nbsp; 
        考次：<asp:TextBox ID="txtName" runat="server" Width="108px" CssClass="searchbox"></asp:TextBox>
