<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qxdm_AddEdit.aspx.cs" Inherits="SincciKC.websystem.jcsj.Qxdm_AddEdit" %>
...
<body>
    <form id="form1" runat="server">
        <table class="windowTable">
            <tr>
                <td colspan="2" class="title">县区信息设置</td>
            </tr>

            <tr>
                <td class="labelRedTD">县区代码：</td>
                <td class="contentTD"><asp:TextBox ID="txtXqdm" onKeyUp="checknum(this);" CssClass="input1" runat="server" MaxLength="4"></asp:TextBox></td>
            </tr>
