<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Jsxm_Manage.aspx.cs" Inherits="SincciKC.websystem.tyxm.Jsxm_Manage" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function opdg(ID, Title) {
            ymPrompt.win({ message: 'Jsxm_AddEdit.aspx?ID=' + ID, width: 400, height: 300, title: Title, iframe: true, fixPosition: true, dragOut: false })
            return false;
        }
        function SelectAll() {
