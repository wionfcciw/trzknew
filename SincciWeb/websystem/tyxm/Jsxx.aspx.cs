...
namespace SincciKC.websystem.tyxm
{
    public partial class Jsxx : System.Web.UI.Page
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            bool result = bllxxgl.Delete_zk_ksjsks(hfDelIDS.Value.Split(',').ToList());
        ...
        protected void btndaoAll_Click(object sender, EventArgs e)
        {
            ...
            string name = "导出加试报名信息" + DateTime.Now.ToLongDateString();
            ...
            gvOrders.DataSource = bllxxgl.selecjsDaochu(where);
