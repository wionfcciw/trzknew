<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LqTJS_num.aspx.cs" Inherits="SincciKC.websystem.zklq.LqTJS_num" %>
...
<body>
   ...
   <div id="tb" class="datagrid-toolbar"  >
         <table>
            ...
            <asp:Button ID="btnsss" runat="server" Text="  转换到个人"  CssClass="icon-reload btn" 
                     onclick="btnsss_Click"    />
             </td>
    ...
    <div id="tbpage" class="datagrid-toolbar" style="padding-left: 10px">
     ...
     <div runat="server"  class="datagrid-toolbar">
         <span id="ImportData" runat="server" >&nbsp;&nbsp;数据导入：<asp:FileUpload ID="fuExcelFileImport" runat="server" />
             ...
             onclick="btnDTxt_Click" Visible="false" />        <a href="../../Template/tjs2.xls">模板下载</a></span>
