...
{
    public partial class LqTJS_wjs : BPage
    {
        ...
        private void BindGv()
        {
            ...
            DataTable tab = bll.Execute_TJS3(strWhere, pageSize, AspNetPager1.CurrentPageIndex, ref RecordCount);
        ...
        {
            bool result = bll.DeleteData_Tjs3(hfDelIDS.Value.Split(',').ToList());
        ...
        protected void btnExcelFileImport_Click(object sender, EventArgs e)
        {
            ...
            if (fuExcelFileImport.HasFile)
            {
                ...
                string result = new BLL_zk_hege().ImportExcelData_Wjs(path);
                string E_record = "导入: 往届生数据:" + config.FormatDateToStringId(DateTime.Now) + fileExtension;
