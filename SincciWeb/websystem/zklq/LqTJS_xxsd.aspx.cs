...
{
    public partial class LqTJS_xxsd : BPage
    {
        ...
        private void BindGv()
        {
            ...
            DataTable tab = bll.Execute_TJS6(strWhere, pageSize, AspNetPager1.CurrentPageIndex, ref RecordCount);
        ...
        {
            bool result = bll.DeleteData_Tjs6(hfDelIDS.Value.Split(',').ToList());
        ...
        protected void btnExcelFileImport_Click(object sender, EventArgs e)
        {
            ...
            if (fuExcelFileImport.HasFile)
            {
                ...
                string result = new BLL_zk_hege().ImportExcelData_XXsd(path);
                string E_record = "导入: 招生学校结清数据:" + config.FormatDateToStringId(DateTime.Now) + fileExtension;
