...
{
    public partial class LqTJS_yt : BPage
    {
        ...
        private void BindGv()
        {
            ...
            DataTable tab = bll.Execute_TJS4(strWhere, pageSize, AspNetPager1.CurrentPageIndex, ref RecordCount);
        ...
        {
            bool result = bll.DeleteData_Tjs4(hfDelIDS.Value.Split(',').ToList());
        ...
        protected void btnExcelFileImport_Click(object sender, EventArgs e)
        {
            ...
            if (fuExcelFileImport.HasFile)
            {
                ...
                string result = new BLL_zk_hege().ImportExcelData_Yt(path);
