<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XQ_SH.aspx.cs" Inherits="SincciKC.websystem.zklq.XQ_SH" %>
...
<body>
    <form id="form1" runat="server">
        <table class="windowTable">
            <tr>
                <td colspan="2" class="title">考生审核不通过</td>
            </tr>
