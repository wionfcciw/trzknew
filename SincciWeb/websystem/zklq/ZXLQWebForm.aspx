<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZXLQWebForm.aspx.cs"
    Inherits="SincciKC.ZXLQWebForm" %>
                    ...
                    try {
                        if (inputs[i].checked) {
                            if (inputs[i].id != "checkboxid")
                                elem[i - 8].parentNode.parentNode.style.backgroundColor = '#EEF5FF';
                        }
                        else {
                            if (inputs[i].id != "checkboxid")
                                elem[i - 8].parentNode.parentNode.style.backgroundColor = '';
                        }
                    } catch (e) {
                                   ...
                                   <asp:GridView ID="repDisplay" runat="server" ForeColor="#333333" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="总分" SortExpression="cj">
                                          ...
                                          <asp:TemplateField HeaderText="注销学校" SortExpression="zxlqxx">
                                            <ItemTemplate>
                                                 <%# Eval("zxlqxx")%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                       
                                        <asp:TemplateField HeaderText="专业"  SortExpression="zxlqzy">
                                            <ItemTemplate>
                                                 <%# Eval("zxlqzy")%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="注销原因"  SortExpression="zxyy">
                                            <ItemTemplate>
                                                 <%# Eval("zxyy")%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="审核状态" SortExpression="xq_zt">
                                            <ItemTemplate>
                                               <%#Eval("xq_zt").ToString() == "2" ? "已发档" : Eval("xq_zt").ToString() == "3" ? "预退" : Eval("xq_zt").ToString() == "4" ? "预录" : Eval("xq_zt").ToString() == "5" ? "录取" : Eval("xq_zt").ToString() == "1" ? "已投" : "在库"%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
