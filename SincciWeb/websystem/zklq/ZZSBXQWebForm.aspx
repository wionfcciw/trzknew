<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZZSBXQWebForm.aspx.cs"
    Inherits="SincciKC.ZZSBXQWebForm" %>
       ...
       <%--     <tr>
            ...
            <tr>
                <td style="text-align: left; vertical-align: top;">
                    <table border="1" cellpadding="4" cellspacing="0" style="width: 100%; border-collapse: collapse;height: 400px;">
                        ...
                        <tr style="height: 45px;">
                            <td>
                                <table style="width: 100%;">
                                    ...
                                    <tr><td>
                                   不通过原因:<asp:TextBox ID="txtyij" runat="server" Width="180px"></asp:TextBox>   
                                    </td></tr>
                                </table>
                            </td>
                        </tr>
