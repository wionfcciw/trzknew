<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zysz_tbtj_bj_where.aspx.cs" Inherits="SincciKC.websystem.zysz.zysz_tbtj_bj_where" %>
...
.btn
{
    ...
    <script type="text/javascript">
        function opdg(ID, Title) {
            ...
            window.parent.addTab2(Title, '/websystem/zygl/zysz_tbtj_bj_where.aspx?where&xqdm=' + ID + '&title=' + Title);
            return false;
        }
    </script>
</head>
<body>
    <form id="form1" runat="server"  >
     ...
     <div id="Div1" class="datagrid-toolbar" style="text-align:center" >
          <span class="font20" >班级志愿填报分析</span> </div>
