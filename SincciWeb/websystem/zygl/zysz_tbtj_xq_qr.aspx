<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zysz_tbtj_xq_qr.aspx.cs" Inherits="SincciKC.websystem.zysz.zysz_tbtj_xq_qr" %>
...
.btn
{
    ...
    <script type="text/javascript">
        function opdg(ID, Title) {
            ...
            window.parent.addTab2(Title, '/websystem/zygl/zysz_tbtj_xx_qr.aspx?xqdm=' + ID + '&title=' + Title);
            return false;
        }
    </script>
</head>
         ...
         <ItemTemplate> 
                  ...
                  <%--  <td><%# (page - 1) * pagesize + Container.ItemIndex + 1%></td>   --%>
                     ...
                     <td><%#Eval("zjqrrs")%></td> 
                      ...
                      <td><%#Eval("wjqrrs")%> </td> 
                      <td><%#Eval("wjwqrrs")%></td> 
                      <td>  <a href="#" onclick="return opdg('<%#Eval("xqdm")%>','学校志愿确认统计');"><%#Eval("xqmc").ToString()=="合计"?"":"详情" %></a>
                      </td>                 
