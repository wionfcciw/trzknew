<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zysz_tbtj_xx_qr.aspx.cs" Inherits="SincciKC.websystem.zysz.zysz_tbtj_xx_qr" %>
...
<body>
    <form id="form1" runat="server"  >
     ...
     <div id="tb" class="datagrid-toolbar"  style="text-align:center" >
         <span class="font20" >学校确认志愿统计</span>
             </div>
