<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HegeKs_Manage.aspx.cs" Inherits="SincciKC.websystem.zysz.HegeKs_Manage" %>
   ...
   <div id="tb" class="datagrid-toolbar"  >
         <table>
            ...
            OnClientClick="return MsgYes();" OnClick="btnDelete_Click" /> </td>
             <td>  <asp:Button ID="btnAdd" runat="server" Text="  添加" CssClass="icon-add btn" 
                      OnClientClick="return opdg('', '添加合格名单')"/> </td>
               
                 <td>类型：
                     <asp:DropDownList ID="dlistXx" runat="server" >
                     <asp:ListItem  Value="">请选择</asp:ListItem>
                         <asp:ListItem Value="1">男儿幼儿师范</asp:ListItem>
                         <asp:ListItem Value="2">师范艺术配额生</asp:ListItem>
                         <asp:ListItem Value="3">统招生</asp:ListItem>
                          <asp:ListItem Value="4">普通艺术配额生</asp:ListItem>
                         <%--    <asp:ListItem Value="4">普高国际班</asp:ListItem>
                         <asp:ListItem Value="5">师范(音乐、美术、学前教育专业)</asp:ListItem>--%>
        ...
        <HeaderTemplate>
         ...
         <ItemTemplate> 
                   <tr style="height:24px" class="datagrid-body" <%# (Container.ItemIndex+1) % 2 ==0?"bgcolor='#F7F7F7'":"" %> >
                     ...
                     <td><%#Eval("ksh")%></td> 
                      <td><%#Eval("xm")%></td> 
                      <td><%#Eval("type").ToString() == "1" ? "男儿幼儿师范" : Eval("type").ToString() == "2" ? "师范配额生" : Eval("type").ToString() == "3" ? "统招生" : Eval("type").ToString() == "4" ? "普高艺术生" :  "师范(音乐、美术、学前教育专业)" %> </td> 
                    </tr>
         </ItemTemplate>
    ...
    <div id="tbpage" class="datagrid-toolbar" style="padding-left: 10px">
     ...
     <div runat="server"  class="datagrid-toolbar">
         <span id="ImportData" runat="server" >&nbsp;&nbsp;数据导入：<asp:FileUpload ID="fuExcelFileImport" runat="server" />
             ...
             OnClientClick="return addMask();"     OnClick="btnExcelFileImport_Click" /> 
               <asp:Button ID="btnDTxt" runat="server"  Text="下载日志" 
             onclick="btnDTxt_Click" />        <a href="../../Template/hege.xls">模板下载</a></span>
          <span  id="ExPortData" runat="server" > &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnExport" runat="server" 
             Text="  导出数据" CssClass="icon-reload btn" onclick="btnExport_Click"
                />    </span>
    </div>
