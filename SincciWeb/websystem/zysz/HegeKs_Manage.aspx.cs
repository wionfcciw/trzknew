...
{
    public partial class HegeKs_Manage : BPage
    {
        ...
        private void BindGv()
        {
            ...
            DataTable tab = bll.ExecuteProc3(strWhere, pageSize, AspNetPager1.CurrentPageIndex, ref RecordCount);
        ...
        {
            bool result = bll.DeleteDatakshkcj(hfDelIDS.Value.Split(',').ToList());
        ...
        protected void btnExcelFileImport_Click(object sender, EventArgs e)
        {
            ...
            if (fuExcelFileImport.HasFile)
            {
                ...
                string result = new BLL_zk_hege().ImportExcelData(path, dlistXx.SelectedValue);
                string E_record = "导入: 合格数据:" + config.FormatDateToStringId(DateTime.Now) + fileExtension;
