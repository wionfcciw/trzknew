<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetZZSBDate.aspx.cs" Inherits="SincciKC.websystem.zysz.SetZZSBDate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>设置填报志愿时间</title>
...
<body>
    ...
    <table class="tbColor" id="GridView1" border="1" style="border-collapse: collapse;"
      ...
      注：设置自主申报开始时间和报名结束时间必须在大市规定时间范围内。
      </div>
    </form>
</body>
</html>
