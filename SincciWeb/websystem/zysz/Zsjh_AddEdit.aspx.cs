...
{
    public partial class Zsjh_AddEdit : BPage
    {
        ...
        private void GetData()
        {
            ...
            {
                Model_zk_zsjh model = bll.Disp(Request.QueryString["ID"].ToString());
        ...
        protected void btnEnter_Click(object sender, EventArgs e)
        {
           ...
           if (ddlZydm.SelectedItem != null)
            ...
            {
                //修改数据
                model.Lsh = bll.Disp(config.CheckChar(Request.QueryString["ID"].ToString())).Lsh;
                result = bll.update_zk_zsjh(model);
            }
            string E_record = "新增: 招生计划：" + config.CheckChar(Request.QueryString["ID"].ToString()) + "";
