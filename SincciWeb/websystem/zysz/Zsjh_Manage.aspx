<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zsjh_Manage.aspx.cs" Inherits="SincciKC.websystem.zysz.Zsjh_Manage" %>
...
<script type="text/javascript">
    ...
    function opdg(ID, Title) {
        ...
        ymPrompt.win({ message: 'Zsjh_AddEdit.aspx?ID=' + ID, width: 440, height: 370, title: Title, iframe: true, fixPosition: true, dragOut: false })
        return false;
    }
...
<body>
     ...
     <div id="tb" class="datagrid-toolbar"  >
         <table>
             ...
             <tr>
                 ...
                 <td>
                     <asp:Button ID="btnExport" runat="server" Text="  导出数据(EXCEL)" CssClass="icon-add btn" 
                         onclick="btnExport_Click"  />
                 </td>
                 <td>
                     <asp:Button ID="btnDBF" runat="server" Text="  导出数据(DBF)" 
                         CssClass="icon-add btn" onclick="btnDBF_Click" 
                          />
                 </td>
             </tr>
         </table>
    ...
    <asp:Button ID="btnExcelFileImport" runat="server" Text="  导入数据"   OnClientClick="addMask();"
        ...
        <a href="../../Template/zsjhTemplate.xls">模板下载</a>
    </div>
