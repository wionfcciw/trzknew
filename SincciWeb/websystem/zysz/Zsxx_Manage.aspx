<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zsxx_Manage.aspx.cs" Inherits="SincciKC.websystem.zysz.Zsxx_Manage" %>
...
<script type="text/javascript">
    ...
    function opdg(ID, Title) {
        ymPrompt.win({ message: 'Zsxx_AddEdit.aspx?ID=' + ID, width: 340, height: 215, title: Title, iframe: true, fixPosition: true, dragOut: false })
        return false;
    }
...
<body>
      ...
      <asp:Repeater ID="Repeater1" runat="server">
        <HeaderTemplate>
         ...
         <ItemTemplate> 
                   ...
                   <td><input type="checkbox" name="CheckBox1" id="CheckBox1" value='<%# Eval("zsxxdm") %>'> </td>
                    <td> 
                    ...
                    <td>
                        <a href="#" onclick="return opdg('<%# Eval("zsxxdm") %>' ,'修改数据');">
    ...
    <asp:Button ID="btnExcelFileImport" runat="server" Text="导入"
        ...
        <a href="../../Template/zsxxTemplate.xls">模板下载</a>
    </div>
